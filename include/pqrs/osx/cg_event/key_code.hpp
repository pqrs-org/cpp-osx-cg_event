...
constexpr auto usage_page_keyboard_or_keypad_map = mapbox::eternal::map<hid::usage::value_t, value_t>({
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_a),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_b),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_c),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_d),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_e),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_g),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_h),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_i),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_j),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_k),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_l),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_m),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_n),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_o),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_p),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_q),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_r),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_s),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_t),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_u),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_v),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_w),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_x),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_y),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_z),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_1),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_2),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_3),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_4),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_5),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_6),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_7),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_8),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_9),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_0),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_return_or_enter),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_escape),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_delete_or_backspace),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_tab),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_spacebar),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_hyphen),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_equal_sign),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_open_bracket),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_close_bracket),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_backslash),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_non_us_pound),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_semicolon),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_quote),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_grave_accent_and_tilde),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_comma),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_period),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_slash),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_caps_lock),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f1),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f2),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f3),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f4),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f5),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f6),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f7),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f8),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f9),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f10),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f11),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f12),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_print_screen),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_scroll_lock),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_pause),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_insert),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_home),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_page_up),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_delete_forward),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_end),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_page_down),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_right_arrow),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_left_arrow),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_down_arrow),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_up_arrow),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_num_lock),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_slash),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_asterisk),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_hyphen),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_plus),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_enter),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_1),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_2),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_3),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_4),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_5),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_6),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_7),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_8),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_9),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_0),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_period),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_non_us_backslash),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_application),
    // keyboard_power
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_equal_sign),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f13),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f14),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f15),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f16),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f17),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f18),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f19),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_f20),
    // keyboard_f21
    // keyboard_f22
    // keyboard_f23
    // keyboard_f24
    // keyboard_execute
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_help),
    // keyboard_menu
    // keyboard_select
    // keyboard_stop
    // keyboard_again
    ...
    // keyboard_locking_num_lock
    // keyboard_locking_scroll_lock
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keypad_comma),
    // keypad_equal_sign_as400
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_international1),
    // keyboard_international2
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_international3),
    // keyboard_international4
    // keyboard_international5
    // keyboard_international6
    // keyboard_international7
    // keyboard_international8
    // keyboard_international9
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_lang1),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_lang2),
    // keyboard_lang3
    // keyboard_lang4
    // keyboard_lang5
    // keyboard_lang6
    ...
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_left_control),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_left_shift),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_left_alt),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_left_gui),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_right_control),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_right_shift),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_right_alt),
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(keyboard_right_gui),
});
...
constexpr auto usage_page_apple_vendor_keyboard_map = mapbox::eternal::map<hid::usage::value_t, value_t>({
    ...
    PQRS_OSX_CG_EVENT_KEY_CODE_PAIR(expose_all),
});
...
namespace std {
template <>
struct hash<pqrs::osx::cg_event::key_code::value_t> : type_safe::hashable<pqrs::osx::cg_event::key_code::value_t> {
};
} // namespace std
